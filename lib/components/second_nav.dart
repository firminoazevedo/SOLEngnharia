...
class _SecondNavState extends State<SecondNav> {
  ...
  void initState() {
    ...
    items.add(Nav2ItemClass(false, Icon(Icons.ac_unit), blue));
    items.add(Nav2ItemClass(false, Icon(Icons.ac_unit), orange));
    items.add(Nav2ItemClass(false, Icon(Icons.ac_unit), purple));
    items.add(Nav2ItemClass(false, Icon(Icons.ac_unit), yellow));
    items.add(Nav2ItemClass(false, Icon(Icons.ac_unit), blueLight));
  }
